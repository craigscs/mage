...
class Vaimo_IntegrationBase_Model_Invoice_Comment extends Vaimo_IntegrationBase_Model_Abstract
{
    protected $_invoice;
    ...
    public function setInvoice(Vaimo_IntegrationBase_Model_Invoice $invoice)
    {
